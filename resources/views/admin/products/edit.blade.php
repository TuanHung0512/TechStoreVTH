...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Chỉnh sửa: {{ $product->name }}</h1>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="cpu" value="{{ old('cpu', $product->cpu) }}" placeholder="VD: Core i5 12500H">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">RAM</label>
                                <input type="text" class="form-control" name="ram" value="{{ old('ram', $product->ram) }}" placeholder="VD: 8GB DDR4">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Ổ cứng</label>
                                <input type="text" class="form-control" name="storage" value="{{ old('storage', $product->storage) }}" placeholder="VD: 512GB SSD NVMe">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">VGA</label>
                                <input type="text" class="form-control" name="vga" value="{{ old('vga', $product->vga) }}" placeholder="VD: RTX 3050 4GB">
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label">Màn hình (của Laptop/PC)</label>
                                <input type="text" class="form-control" name="screen" value="{{ old('screen', $product->screen) }}" placeholder="VD: 15.6 inch FHD 144Hz">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_screen_size" value="{{ old('spec_screen_size', $product->spec_screen_size) }}" placeholder="VD: 24 inch, 27 inch">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tần số quét</label>
                                <input type="text" class="form-control" name="spec_refresh_rate" value="{{ old('spec_refresh_rate', $product->spec_refresh_rate) }}" placeholder="VD: 144Hz, 165Hz">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tấm nền</label>
                                <input type="text" class="form-control" name="spec_panel_type" value="{{ old('spec_panel_type', $product->spec_panel_type) }}" placeholder="VD: IPS, VA, TN">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_type" value="{{ old('spec_type', $product->spec_type) }}" placeholder="VD: DDR4, DDR5, SSD NVMe Gen 4">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Dung lượng</label>
                                <input type="text" class="form-control" name="spec_capacity" value="{{ old('spec_capacity', $product->spec_capacity) }}" placeholder="VD: 8GB, 16GB, 512GB, 1TB">
                            </div>
                             <div class="col-md-6 mb-3">
                                <label class="form-label">Tốc độ (nếu có)</label>
                                <input type="text" class="form-control" name="spec_speed" value="{{ old('spec_speed', $product->spec_speed) }}" placeholder="VD: 3200MHz, 7000MB/s">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_connection_type" value="{{ old('spec_connection_type', $product->spec_connection_type) }}" placeholder="VD: Không dây, Có dây, Bluetooth">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">DPI (cho chuột)</label>
                                <input type="text" class="form-control" name="spec_dpi" value="{{ old('spec_dpi', $product->spec_dpi) }}" placeholder="VD: 16000 DPI">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Loại Switch (cho phím)</label>
                                <input type="text" class="form-control" name="spec_switch_type" value="{{ old('spec_switch_type', $product->spec_switch_type) }}" placeholder="VD: Red Switch, Brown Switch">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_chip" value="{{ old('spec_chip', $product->spec_chip) }}" placeholder="VD: Apple M2, Snapdragon 8 Gen 2">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Màn hình</label>
                                <input type="text" class="form-control" name="spec_screen_info" value="{{ old('spec_screen_info', $product->spec_screen_info) }}" placeholder="VD: 11 inch Liquid Retina">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">RAM</label>
                                <input type="text" class="form-control" name="spec_ram_options" value="{{ old('spec_ram_options', $product->spec_ram_options) }}" placeholder="VD: 8GB, 16GB">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Bộ nhớ trong</label>
                                <input type="text" class="form-control" name="spec_storage_options" value="{{ old('spec_storage_options', $product->spec_storage_options) }}" placeholder="VD: 128GB, 256GB">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_function" value="{{ old('spec_function', $product->spec_function) }}" placeholder="VD: In, Scan, Copy, Fax">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tốc độ in</LAbel>
                                <input type="text" class="form-control" name="spec_print_speed" value="{{ old('spec_print_speed', $product->spec_print_speed) }}" placeholder="VD: 20 trang/phút">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Khổ giấy</label>
                                <input type="text" class="form-control" name="spec_paper_size" value="{{ old('spec_paper_size', $product->spec_paper_size) }}" placeholder="VD: A4, A3">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="spec_wifi_standard" value="{{ old('spec_wifi_standard', $product->spec_wifi_standard) }}" placeholder="VD: Wi-Fi 6 (802.11ax)">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Số cổng</label>
                                <input type="text" class="form-control" name="spec_ports" value="{{ old('spec_ports', $product->spec_ports) }}" placeholder="VD: 4x LAN 1Gbps, 1x WAN 1Gbps">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Ăng ten</label>
                                <input type="text" class="form-control" name="spec_antenna" value="{{ old('spec_antenna', $product->spec_antenna) }}" placeholder="VD: 4 ăng ten 5dBi">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        @if($product->thumbnail)
                            <div class="mt-2">
                                ...
                                {{-- === ĐÃ SỬA LỖI Ở DÒNG NÀY (Bỏ chữ 'G' thừa) === --}}
                                <img src="{{ asset('storage/' . $product->thumbnail) }}" alt="{{ $product->name }}" style="max-width: 150px; border-radius: 4px;">
                            </div>
                        @endif
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // 1. Chạy 1 lần khi trang tải (quan trọng cho trang EDIT)
        toggleSpecGroups();
